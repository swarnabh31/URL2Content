...
1. **Paste a YouTube URL** — Any YouTube video link
2. **Extract Transcript** — Click to pull captions
3. **Choose a Model** — Select from the sidebar dropdown (auto-detected)
4. **Select Content Type** — Summary, Blog, Article, or LinkedIn
5. **Generate** — Click to create your content
6. **Copy or Download** — Copy-paste directly or download as `.md`
